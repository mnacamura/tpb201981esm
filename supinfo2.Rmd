---
title: "Supplementary Information 2: \\protect\\linebreak Bayesian Inference of the TAM spectrum"
...
header-includes: |
    ...
    \affil[3]{Department of Management, Kochi University of Technology, Japan}
---
...
data sets (Main Text Sec.\ 4) by means of Bayesian MCMC.
...
```{r plot_empirical, fig.cap = "\\label{fig:plot-empirical}Posterior predictions of TAM: empirical data (black points), posterior means (red lines), and 95\\% credible intervals (transparent red ribbons)."}
...
\cdots, 200,000$ and use the all snapshots to infer the parameters.
...
```{r plot_IBM, fig.height = 2, fig.cap = "\\label{fig:plot-IBM}Posterior predictions of TAM: artificial data (black points), posterior means (red lines), and 95\\% credible intervals (transparent red ribbons)."}
