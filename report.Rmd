...
If one sees the data as a popularity--frequency table, i.e.
\begin{equation}
...
Since \cref{eq:log-likelihood-for-table} is computationally more efficient than
\cref{eq:log-likelihood}, we use \cref{eq:log-likelihood-for-table} in practice.

# Bayesian MCMC

Using \cref{eq:log-likelihood-for-table}, we estimated parameters for each of
...
$m_k$ in \cref{eq:log-likelihood-for-table} is not necessarily integer.
