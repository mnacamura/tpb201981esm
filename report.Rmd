...
if (file.exists(cache)) {
    ...
    results <- foreach(data_set = data_sets) %dopar% {
        ks <- data_set$table$popularity
        ms <- data_set$table$frequency
        sampling( model
...
One may want to see the data $k_1^m$ as a popularity--frequency table
\begin{equation}
...
For \cref{eq:data-as-table}, \cref{eq:log-likelihood} can be represented as
\begin{align}
