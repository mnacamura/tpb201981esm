...
# logscale_label <- scales::trans_format("log10", scales::math_format(10^.x))
...
```{r plot, echo = FALSE, fig.width = 5, fig.height = 4, fig.cap = "\\label{fig:plot}Fitted TAM spectra (red lines) to empirical data (black points)."}
